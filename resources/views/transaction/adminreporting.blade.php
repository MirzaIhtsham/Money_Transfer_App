...
@section('content')
@section('specific_title','Reporting')
        ...
        <div class="row">
            <div class="col-12">
                <div class="callout callout-info">
                    ...
                    Please select the required filters below to generate the sender report.
                </div>

                <!-- Filters Form for Admin -->
                <form action="{{ route('admin.sender.report') }}" method="POST">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-md-3">
                ...
                <!-- Display Admin Transaction List -->
