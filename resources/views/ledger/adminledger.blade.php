                    ...
                    <tbody>
                        @forelse ($ledgers as $ledger)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-gray-700">{{ class_basename($ledger->user_type) }}</td>
                                <td class="px-6 py-4 text-green-600 font-semibold">{{ $ledger->user_id }}</td>
                                ...
                                <td class="px-6 py-4 text-green-600 font-semibold">User Balance :{{ $ledger->balance }}</td>
    ...
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td >{{ class_basename($ledger->user_type) }}</td>
            <td >{{ $ledger->user_id }}</td>
            <td >{{ $ledger->debit }}</td>
            <td >{{ $ledger->credit }}</td>
            <td >User Balance :{{ $ledger->balance }}</td>
