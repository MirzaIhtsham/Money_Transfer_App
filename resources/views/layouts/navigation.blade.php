        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('payout_method.index')" :active="request()->routeIs('payout_method.index')">
                        {{ __('Payout Method') }}
                    </x-nav-link>
                    <x-nav-link :href="route('transaction.admin.history')" :active="request()->routeIs('transaction.admin.history')">
                        {{ __('Transaction History') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.ledgers.View')" :active="request()->routeIs('admin.ledgers.View')">
                    ...
                    @can('isadmin')
                    <x-nav-link :href="route('send.money')" :active="request()->routeIs('send.money')">
                        {{ __('Transaction') }}
                    </x-nav-link> 
                    <x-nav-link :href="route('transaction.history')" :active="request()->routeIs('transaction.history')">
                        {{ __('Transaction History') }}
                    </x-nav-link>
                    <x-nav-link :href="route('user.ledgers.View')" :active="request()->routeIs('user.ledgers.View')">
                        {{ __('Transaction Ledger') }}
                    </x-nav-link>
